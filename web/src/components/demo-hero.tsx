...
export function DemoHero({ className }: DemoHeroProps) {
  ...
  return (
    <div className={cn("flex flex-col gap-3 shrink-0", className)}>
      {isCollapsed ? (
        /* Compact Executive Command Strip */
        <Card className="border-border bg-card/85 py-2.5 px-4 backdrop-blur-md">
          <CardContent className="flex flex-wrap items-center justify-between gap-3 p-0">
            <div className="flex items-center gap-3">
              <div className="relative">
                <PhalanxProductMark className="size-6 shadow-[0_0_12px_rgba(76,201,217,0.35)]" />
              </div>
              <div className="flex items-center gap-2.5">
                ...
                {isRunning ? (
                  <Badge variant="outline" className="border-warning/40 bg-warning/10 text-warning text-[10px] font-mono h-5 py-0 px-2 gap-1.5">
                    <StatusDot tone="warning" pulse size="xs" />
                    <span>ENGAGED ({incidents.length} ACTIVE)</span>
                  </Badge>
                ) : (
                  <Badge variant="outline" className="border-positive/30 bg-positive/10 text-positive text-[10px] font-mono h-5 py-0 px-2 gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="hidden sm:flex items-center gap-1.5">
                <Button
                  ...
                  className={cn(
                    "font-mono text-[11px] h-6.5 px-2.5 border-border/80 transition-all",
                    isZeroDayActive && "border-destructive/70 bg-destructive/15 text-destructive shadow-[0_0_10px_rgba(242,86,95,0.25)]",
                  )}
                ...
                <Button
                  ...
                  className={cn(
                    "font-mono text-[11px] h-6.5 px-2.5 border-border/80 transition-all",
                    isIdentityActive && "border-warning/70 bg-warning/15 text-warning shadow-[0_0_10px_rgba(224,179,77,0.25)]",
                  )}
                ...
                <Button
                  ...
                  className={cn(
                    "font-mono text-[11px] h-6.5 px-2.5 border-border/80 transition-all",
                    isCampaignActive && "border-primary/70 bg-primary/15 text-primary shadow-[0_0_10px_rgba(76,201,217,0.25)]",
                  )}
              ...
              <div className="flex items-center gap-1.5 rounded-control border border-border/80 bg-black/40 px-2 py-0.5 text-[10px] font-mono">
              ...
              <Button
                ...
                className="h-6.5 px-2 text-[11px] font-mono border-border/80 hover:border-destructive/40 hover:text-destructive"
        ...
        <Card className="border-border bg-card/85 backdrop-blur-md shadow-2xl relative overflow-hidden">
          {/* Subtle top tactical accent line */}
          ...
          <CardContent className="p-4 sm:p-5">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between border-b border-border/60 pb-4">
              <div className="flex items-center gap-3.5">
                <div className="relative">
                  <PhalanxProductMark className="size-8.5 shadow-[0_0_16px_rgba(76,201,217,0.35)]" />
                </div>
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h2 className="font-mono text-xs sm:text-sm font-bold tracking-wider text-foreground uppercase">
                      PHALANX AUTONOMOUS BLUE-TEAM SWARM
                    </h2>
                    <span className="rounded border border-primary/30 bg-primary/10 px-2 py-0.5 font-mono text-[10px] font-medium text-primary">
                      A2A PROTOCOL MESH
                    </span>
                  </div>
              ...
              <div className="flex items-center gap-2 self-start md:self-auto shrink-0">
                ...
                <Button
                  ...
                  disabled={busyAction !== null}
                  onClick={() => void handleReset()}
                  className="h-7 px-2.5 text-[11px] font-mono border-border/80 hover:border-destructive/40 hover:text-destructive"
            ...
            {isRunning ? (
              <div className="mt-3.5 rounded-item border border-warning/40 bg-warning/[0.05] p-2.5 flex flex-wrap items-center justify-between gap-3 shadow-inner">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-mono text-[11px] text-muted-foreground">
                    CONTAINMENT PHASE: <strong className="text-foreground font-semibold">{currentPhase}</strong>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3 font-mono text-[11px]">
                  <div className="flex items-center gap-1 text-muted-foreground">
                    ...
                    <span>ELAPSED: <strong className="text-foreground font-bold">{elapsedFormatted}</strong></span>
                  </div>
            ...
            {notice ? (
              <div className="mt-3 flex items-center gap-2 rounded-item border border-warning/40 bg-warning/10 px-3 py-2 text-xs text-warning font-mono">
            ...
            <div className="mt-4">
              <div className="mb-2.5 flex items-center justify-between">
                <span className="soc-micro-label text-muted-foreground">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                ...
                <div
                  className={cn(
                    "flex flex-col justify-between rounded-item border p-4 transition-all bg-card/60 relative overflow-hidden",
                    isZeroDayActive
                      ? "border-destructive/70 bg-destructive/[0.06] shadow-[0_0_20px_rgba(242,86,95,0.2)]"
                      : "border-border/70 hover:border-border hover:bg-card/85",
                  )}
                >
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center justify-between gap-2 border-b border-border/40 pb-2">
                      ...
                      <Badge variant="destructive" className="h-4.5 px-1.5 font-mono text-[9px] font-bold border-destructive/40 bg-destructive/20 text-destructive">
                        SEV-1 CRITICAL
                      </Badge>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 font-mono text-[10px]">
                      ...
                      <span className="rounded border border-border/60 bg-black/40 px-1.5 py-0.5 text-muted-foreground">
                        T1190 · T1552 · T1041
                      </span>
                    </div>
                    ...
                    <div className="mt-1 rounded-item border border-border/50 bg-black/30 p-2 font-mono text-[9px] text-muted-foreground flex flex-col gap-1">
                      <span className="uppercase text-[8.5px] tracking-wider text-muted-foreground/70">Tactical Defense Flow:</span>
                  ...
                  <div className="mt-4 pt-3 border-t border-border/40">
                    <Button
                      ...
                      onClick={() => void launch("zero-day-edge", () => phalanxApi.runScenario("zero-day-edge"), isZeroDayRan)}
                      className={cn(
                        "w-full h-7.5 text-[11px] font-mono border-border/80 justify-center gap-1.5 transition-all",
                        isZeroDayActive && "border-destructive/70 bg-destructive/20 text-destructive hover:bg-destructive/25 shadow-[0_0_12px_rgba(242,86,95,0.3)]",
                        !isZeroDayActive && !isZeroDayRan && "bg-secondary/80 hover:bg-secondary text-foreground hover:border-primary/50",
                ...
                <div
                  className={cn(
                    "flex flex-col justify-between rounded-item border p-4 transition-all bg-card/60 relative overflow-hidden",
                    isIdentityActive
                      ? "border-warning/70 bg-warning/[0.06] shadow-[0_0_20px_rgba(224,179,77,0.2)]"
                      : "border-border/70 hover:border-border hover:bg-card/85",
                  )}
                >
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center justify-between gap-2 border-b border-border/40 pb-2">
                      ...
                      <Badge variant="outline" className="h-4.5 px-1.5 font-mono text-[9px] font-bold border-warning/40 bg-warning/20 text-warning">
                        SEV-2 HIGH
                      </Badge>
                    </div>
                  ...
                  <div className="mt-4 pt-3 border-t border-border/40">
                    <Button
                      ...
                      className={cn(
                        "w-full h-7.5 text-[11px] font-mono border-border/80 justify-center gap-1.5 transition-all",
                        isIdentityActive && "border-warning/70 bg-warning/20 text-warning hover:bg-warning/25 shadow-[0_0_12px_rgba(224,179,77,0.3)]",
                        !isIdentityActive && !isIdentityRan && "bg-secondary/80 hover:bg-secondary text-foreground hover:border-primary/50",
                ...
                <div
                  className={cn(
                    "flex flex-col justify-between rounded-item border p-4 transition-all bg-card/60 relative overflow-hidden",
                    isCampaignActive
                      ? "border-primary/70 bg-primary/[0.06] shadow-[0_0_20px_rgba(76,201,217,0.2)]"
                      : isCampaignRan
                ...
                >
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center justify-between gap-2 border-b border-border/40 pb-2">
                      ...
                      <Badge variant="outline" className="h-4.5 px-1.5 font-mono text-[9px] font-bold border-primary/40 bg-primary/20 text-primary">
                  ...
                  <div className="mt-4 pt-3 border-t border-border/40">
                    <Button
                      ...
                      className={cn(
                        "w-full h-7.5 text-[11px] font-mono border-border/80 justify-center gap-1.5 transition-all",
                        isCampaignActive && "border-primary/70 bg-primary/20 text-primary hover:bg-primary/25 shadow-[0_0_12px_rgba(76,201,217,0.3)]",
                        !isCampaignActive && !isCampaignRan && "bg-secondary/80 hover:bg-secondary text-foreground hover:border-primary/50",
